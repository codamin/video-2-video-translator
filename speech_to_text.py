...
model_size = "base"  # Using a smaller English-specific model for quicker testing
...
def speech_to_text(audio_file_path, src_language="en"):
    """
    ...
    try:
        ...
        segments, info = model.transcribe(audio_file_path, beam_size=5, language=src_language)
